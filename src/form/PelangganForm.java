...
public class PelangganForm extends javax.swing.JFrame {
    ...
    try {
        ...
        ResultSet rs = stmt.executeQuery("SELECT id_pelanggan FROM pelanggan ORDER BY id_pelanggan DESC LIMIT 1");

        if (rs.next()) {
            String lastId = rs.getString("id_pelanggan");
            int number = Integer.parseInt(lastId.substring(3));
            number++;
            String newId = String.format("PLG%03d", number);
            txtID.setText(newId);
        } else {
            txtID.setText("PLG001");
        }
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Gagal generate ID Pelanggan: " + e.getMessage());
    }
}
    /**
