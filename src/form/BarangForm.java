...
public class BarangForm extends javax.swing.JFrame {
    ...
    try {
        ...
        ResultSet rs = stmt.executeQuery("SELECT kode_barang FROM barang ORDER BY kode_barang DESC LIMIT 1");

        if (rs.next()) {
            String lastId = rs.getString("kode_barang");
            int number = Integer.parseInt(lastId.substring(3));
            number++;
            String newId = String.format("BRG%03d", number);
            txtKodeBarang.setText(newId);
        } else {
            txtKodeBarang.setText("BRG001");
        }
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Gagal generate ID Barang: " + e.getMessage());
    }
}
    /**
...
try {
    ...
    while (r.next()) {
        model.addRow(new Object[]{
            ...
            r.getString("jenis_barang"),
            r.getString("harga_beli"),
