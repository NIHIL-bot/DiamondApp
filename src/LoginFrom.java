...
public class LoginFrom extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String sql = "SELECT login.id_kasir, login.username, kasirform.nama_kasir FROM login JOIN kasirform ON login.id_kasir = kasirform.id_kasir WHERE login.username = ? AND login.password = ?";
        ...
        if (rs.next()) {
            ...
            Session.setNamaKasir(rs.getString("nama_kasir"));
